...
<div class="container mx-auto px-4 py-8">
    ...
    <a href="{{ route('courses.create') }}" class="mb-6 inline-block bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700 transition">
        + Tambah Course
    </a>
        ...
        <div class="bg-white shadow rounded p-6">
            ...
            <div class="ml-4 space-y-4">
                ...
                <div class="border rounded p-4">
                    ...
                    @if($embedUrl)
                        <iframe class="w-full aspect-video my-2 rounded" src="{{ $embedUrl }}" frameborder="0" allowfullscreen></iframe>
                    @else

...
<div class="container mx-auto py-6">
    ...
    <div class="mt-8 grid grid-cols-1 md:grid-cols-2 gap-6">
        <a href="{{ route('admin.courses.index') }}" class="block text-green-900 p-6 rounded-xl shadow-lg transition">
        ...
        <a href="{{ route('admin.sub-courses.index') }}" class="block text-green-900 p-6 rounded-xl shadow-lg transition">
            <div class="flex items-center space-x-4">
                <div class="text-4xl">🧩</div>
                <div>
